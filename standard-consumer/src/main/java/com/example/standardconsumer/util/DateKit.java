package com.example.standardconsumer.util;
...
public class DateKit {
     ...
     * 字符串转换为日期:yyyy-MM-dd
     */
    public static String nowToDateStr(){
        String dateStr = null;
        Calendar now = getCal();
        try {
            dateStr = dateFormat.get().format(now.getTime());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return dateStr;
     ...
     * 字符串转换为时间:yyyy-MM-dd HH:mm:ss
     */
    public static String nowToTimeStr(){
        String timeStr = null;
        Calendar now = getCal();
        try {
            timeStr = timeFormat.get().format(now.getTime());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return timeStr;
    ...
    public static void main(String[] args) {
        System.err.println(nowToTimeStr());
    }
}

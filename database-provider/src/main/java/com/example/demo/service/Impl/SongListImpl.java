...
public class SongListImpl implements SongListService {
    ...
    @Override
    public ArrayList<SongList> getSongListById(String songlistid){
    ...
    @Override
    public ArrayList<Song> getSongsInSongList(String songlistid){
        Map<String,Object> map = new HashMap<>();
        map.put("songlistid",songlistid);
    ...
    @Override
    public int getSongListSavedNum(String  songlistid){
        Map<String,Object> map = new HashMap<>();
        map.put("songlistid",songlistid);
